...
# Words used in folder and file names, per language. Any language without
...
LABELS = {
    ...
    "ru": {
        ...
        "recording": "Запись",
        "linto_shortcut": "Подробнее в LinTO",
    },
    "vi": {
        "meetings_root": "Cuộc họp",
        "meeting": "Cuộc họp",
        "summary": "Tóm tắt",
        "transcript": "Bản chép lời",
        "recording": "Bản ghi",
        "linto_shortcut": "Xem thêm trong LinTO",
    },
}
